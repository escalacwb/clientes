...
revoke execute on function public.mobile_crm_clients_search(text) from anon;
revoke execute on function public.mobile_crm_client_details(uuid) from anon;
...
revoke execute on function public.mobile_crm_client_update(uuid, text, text) from anon;
revoke execute on function public.mobile_vehicle_create(text, text, text, integer, text, text, bigint) from anon;
revoke execute on function public.web_vehicle_create_from_plate(text, text, uuid, text, integer) from anon;
...
revoke execute on function public.mobile_vehicle_company_update_crm(bigint, text, uuid) from anon;
...
revoke execute on function public.mobile_save_box_services(integer, jsonb) from anon;
...
revoke execute on function public.mobile_crm_clients_search(text) from public;
revoke execute on function public.mobile_crm_client_details(uuid) from public;
...
revoke execute on function public.mobile_crm_client_update(uuid, text, text) from public;
revoke execute on function public.mobile_vehicle_create(text, text, text, integer, text, text, bigint) from public;
revoke execute on function public.web_vehicle_create_from_plate(text, text, uuid, text, integer) from public;
...
revoke execute on function public.mobile_vehicle_company_update_crm(bigint, text, uuid) from public;
...
revoke execute on function public.mobile_save_box_services(integer, jsonb) from public;
...
grant execute on function public.mobile_crm_clients_search(text) to authenticated, service_role;
grant execute on function public.mobile_crm_client_details(uuid) to authenticated, service_role;
...
grant execute on function public.mobile_crm_client_update(uuid, text, text) to authenticated, service_role;
...
grant execute on function public.web_vehicle_create_from_plate(text, text, uuid, text, integer) to authenticated, service_role;
...
grant execute on function public.mobile_vehicle_company_update_crm(bigint, text, uuid) to authenticated, service_role;
...
grant execute on function public.mobile_save_box_services(integer, jsonb) to authenticated, service_role;
...
grant execute on function public.resumo_patio_revisao_efetividade(integer, date, date) to authenticated, service_role;
